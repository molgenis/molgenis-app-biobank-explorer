...
describe('MultiFilter.vue', () => {
  ...
  it('shows the option as checked that has been given as a prop', async () => {
    ...
    const wrapperFromBookmark = mount(MultiFilter, { localVue, stubs, propsData: bmProps })
    ...
    const checkbox = wrapperFromBookmark.find('input[type=checkbox]').element
  ...
  describe('prop: returnTypeAsObject', () => {
    it('should return only the value when falsy [default]', async () => {
      const checkbox = wrapper.find('input[type=checkbox]').element
