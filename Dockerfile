...
RUN mkdir -p /usr/share/nginx/html/plugin/app/molgenis-app-biobank-explorerimg/
...
COPY dist/img/ /usr/share/nginx/html/plugin/app/molgenis-app-biobank-explorerimg/
