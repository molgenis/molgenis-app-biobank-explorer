...
export default {
  ...
  computed: {
    ...mapGetters(['showCountryFacet', 'activeFilters', 'getFilterDefinitions', 'viewMode']),
    search: {
      get () {
  ...
  methods: {
    ...
    filterChange (name, value) {
      this.UpdateFilterSelection({ name, value, filterDefinitions: this.filterDefinitions, router: this.$router })
    },
